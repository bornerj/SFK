...
> **Guia para criar e usar Skills no SFK — Structured Framework Kit**

---

## 📋 Overview

While the SFK enables powerful AI specialists, they don't know your specific project context or your team's standards by default. Loading every rule into the agent's context window leads to "tool bloat," higher costs, latency, and confusion.

**SFK Skills** solve this through **Progressive Disclosure**. A Skill is a package of specialized knowledge that remains dormant until needed. It is only loaded into the agent's context when your specific request matches the skill's description.
...
By creating Skills, you transform a general AI model into an expert for your project, under the SFK orchestration layer:
